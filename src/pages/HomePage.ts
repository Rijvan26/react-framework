...
export class HomePage extends Page {
  ...
  override onPageReady(): void {  //onPageReady() gives us the safe point to find/use DOM elements
          console.log("HomePage is ready");                           // after the page has been rendered and inserted. ✅
